...
contextBridge.exposeInMainWorld('desktopApi', {
  ...
  querySystemWiki: (payload: unknown) => ipcRenderer.invoke('knowledge:query-system-wiki', payload),
  ingestSystemWiki: (payload: unknown) => ipcRenderer.invoke('knowledge:ingest-system-wiki', payload),
  lintSystemWiki: () => ipcRenderer.invoke('knowledge:lint-system-wiki'),
  buildSystemWikiGraph: () => ipcRenderer.invoke('knowledge:build-system-wiki-graph'),
