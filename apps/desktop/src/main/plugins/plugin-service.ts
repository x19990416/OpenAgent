...
import { getOpenAgentHome } from '@openagent/runtime';
import { PluginConfigStore } from '@openagent/plugin-runtime';
import { PluginSecretStore } from './plugin-secret-store.js';
import { PluginLoader } from '@openagent/plugin-runtime';
import { PluginRuntimeBridge } from '@openagent/plugin-runtime';
import {
  PluginRegistry,
  computeCapabilities,
  isConfigured,
  ...
  validateManifest,
  withConfigDefaults
} from '@openagent/plugin-runtime';
import type { PluginInstallState, PluginRecord, PluginRegistrationResult, PluginRegistrySnapshot } from '@openagent/plugin-runtime';
...
export class PluginService {
  ...
  dispatchUiEvent(event: import('@openagent/runtime').RuntimeUiEvent) {
