...
import { PiCodingAgent, type PiCodingAgentOptions } from './pi-coding-agent.js';
...
export class SubagentService {
  ...
  constructor(knowledgeService: KnowledgeService, options: { piCodingAgent: PiCodingAgentOptions }) {
    this.shellAgent = new ShellAgent();
    this.knowledgeAgent = new KnowledgeAgent(knowledgeService);
    this.piCodingAgent = new PiCodingAgent(options.piCodingAgent);
  }
