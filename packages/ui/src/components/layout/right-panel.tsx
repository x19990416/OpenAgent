import { AgentMemoryPanel } from '../panels/agent-memory-panel';
import { BrowserSessionPanel } from '../panels/browser-session-panel';
import { ContextPanel } from '../panels/context-panel';
import { PatchPanel } from '../panels/patch-panel';
import { PlanPanel } from '../panels/plan-panel';
import { RunLogPanel } from '../panels/run-log-panel';
